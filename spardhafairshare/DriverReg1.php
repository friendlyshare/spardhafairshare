...
<div id="wrapper">
  ...
  <form action="/action_page.php">
   <h3 align="center">DEAR DRIVER!!
     GET REGISTER HERE!!</h3>
    <label for="fname">Name:</label>
    <input type="text" id="dname" name="dname" placeholder="Your name..">

    <label for="fage">age:</label>
    <input type="text" id="dage" name="dage" placeholder="yourr age..">

	<label for="femail">Email:</label>
    <input type="text" id="demail" name="deamil" placeholder="yourr mail id..">

  <label for="fmob">Mobile:</label>
    <input type="text" id="dmob" name="dmob" placeholder="yourr mobile number.">

  <label for="Liscence Id">Liscence Id:</label>
    <input type="text" id="did" name="did" placeholder="yourr liscence Id.">
